          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6 mx-auto">
            <div class="card " style="border-radius: 50px; width: 600px;">
              <div class="card-body p-5">
                <h2 class="text-uppercase text-center mb-5">ADD new office</h2>

                <form name="signup_form" method="POST" action="" onsubmit="return validateForm();">

                  <div class="form-outline mb-4">
                    <label class="form-label">Office Country:</label>
                    <input type="text" placeholder="Enter brand" name="office" class="form-control form-control-lg" />
                  </div>


                  <div class="d-flex justify-content-center">
                    <input type="submit" value="Register" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="subo">
                  </div>
...
if(isset($_POST["subo"]))
{
    ...
    $office=$_POST["office"];
        ...
        $query="INSERT INTO office (country) VALUES ('$office')";
